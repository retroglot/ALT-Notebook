...
平台化的“权力”究竟源于何处？众所周知，平台是连接不同市场或“多方”的中间协调者。本文以领先的音频流媒体平台 Spotify 为例，通过分析其嵌入的三个关键市场——音乐市场、广告市场和金融市场——来探讨平台权力的动态机制。研究以播放列表为切入点。播放列表可被视为平台（如 Spotify）运用策展或“策展权”来调解市场、以推进自身利益的典型例证。同时，播放列表也是这些市场之间相互冲突的压力与张力的产物。因此，它们提供了一个观察平台经济内部更广泛结构动态的视角。正如对 Spotify 的案例研究所揭示的，平台“权力”始终是一种不稳定且不断变化的结果，源于持续协调不同市场与行动者之间的尝试。
...
> 通过对新闻媒体、行业出版物以及美国证券交易委员会（SEC）文件的仔细阅读，Spotify 为“让各方达成共识”所做的努力，将通过聚焦播放列表这一形式得以阐明。播放列表是 Spotify 组织与呈现音乐的核心方式。无论是由个人还是算法进行编排（参见 Bonini & Gandini, 2019），播放列表都是围绕共同的流派、主题、情绪或活动而组织起来的歌曲合集。研究表明，自大约 2013 年起，Spotify 通过播放列表的策划（Eriksson 等人, 2019），已将自己从音乐分发商转变为一个“品牌化音乐体验”的生产者（Morris & Powers, 2015）。学者们已围绕播放列表展开讨论，涉及粉丝“劳动”的挪用（Drew, 2005）、平台品牌差异化（Morris & Powers, 2015）、用户实践（Hagen, 2015）、数字音乐商品（Morris, 2015）、把关机制（Bonini & Gandini, 2019），以及作为“容器技术”（Eriksson, 2020）等维度。然而，一个关键要素尚未得到审视：播放列表如何揭示平台经济内部更广泛的结构性动态。因此，本文旨在通过 Spotify 播放列表策展的案例研究，探讨平台权力重心的转移轨迹。
...
> 作为众多平台共有的社会技术特征，播放列表揭示了“选择”的政治性（van Dijck 等人，2018）——这是 Spotify 等平台试图建立平台依赖性的关键机制。这引发了令人联想起 1990 年代唱片公司与零售商之间斗争的紧张关系。在《社交媒体+社会》关于文化生产平台化的首期特辑中，Bonini 和 Gandini（2019）研究了平台的“算法策展权力”，强调“人类与算法过程的特定交融”已成为音乐把关的新主体。本文认为，播放列表不仅由编辑逻辑与算法逻辑共同塑造，更受到任一平台所聚合的多重市场之间的压力与张力影响。笔者认为，播放列表为我们提供了一个观察这些多元市场间时而冲突、时而互补的互动关系的透镜。
...
> 接下来，我们将审视 Spotify 所协调的三个最重要的市场：音乐市场、广告市场以及金融市场。尽管已有重要研究探讨了流媒体平台上的播放列表策划机制（Bonini & Gandini, 2019），但本文旨在探讨播放列表究竟为谁服务。
...
> 因此，Spotify 成为整个唱片行业推广工作的焦点并不令人意外。这些关注很大程度上集中在播放列表上。播放列表被称为“新电台”，因为它们对推广新歌曲和艺术家具有影响力（Shah，2018）。然而，并非所有播放列表都具有同等影响力：其影响力差异巨大，且很大程度上取决于播放列表的所有者。
...
> 然而，尽管这些主流唱片公司的播放列表已成为推广和分发旗下签约艺人音乐的重要工具，真正的热门制造者却是 Spotify 自行拥有并策划的播放列表。Spotify 已创建了数千个自有播放列表。[^1] 其中排名第一的 Spotify 策划播放列表——由算法生成的“Today's Top Hits”——拥有超过 2200 万关注者。[^2] 截至 2019 年 1 月，Spotify 上关注人数最多的 35 个播放列表均为 Spotify 自行策划；在前 100 个播放列表中，有 99 个属于此类。根据为欧盟委员会进行的一项研究，
>  
> > - Spotify 的精选歌单占据了前 1000 个播放列表中超过四分之三的粉丝数；Spotify 的算法推荐歌单则占据了另外 9.3% 的份额。由主要唱片公司运营的歌单列表，包括 Filtr、Digster 和 Topsify，分别占据了前 1000 个歌单累计粉丝数的 3.1%、2.7% 和 0.9%。其余的歌单所有者所占份额则微不足道。（Aguiar & Waldfogel, 2018, p. 8）
>   
...
> 或许不足为奇的是， Spotify 推广其自己的播放列表，而反过来， Spotify 策划的播放列表在平台上具有最大的覆盖面和影响力。然而，结果是，为了在音乐行业建立和维持职业生涯，音乐家和唱片公司越来越依赖于登上 Spotify 策划的播放列表（Iqbal, 2019）。研究已经确认了 Spotify 策划的播放列表对艺术家职业生涯的关键重要性（Aguiar & Waldfogel, 2018）。欧盟委员会的研究确定，一首歌曲在 Spotify 的“Today's Top Hits”播放列表中的位置可以带来高达 163,000 美元的额外收入。其他流行的 Spotify 策划的播放列表带来了更高的支付：“Viva Latino!”被发现每首歌曲可以产生 303,047 美元到 424,265 美元的额外收入（Aguiar & Waldfogel, 2018）。更重要的是，位置决定一切：歌曲必须被放置在播放列表的顶部附近，才能产生最大的影响（Aguiar & Waldfogel, 2018, p. 19）。
...
> 通过运用其对音乐消费的认知来控制平台上的音乐策展，Spotify 正在音乐市场中实施一定程度的“逆向整合”。[^3] 音乐艺术家和唱片公司正日益依赖于由 Spotify 控制的精选播放列表中的优势位置。对于像 Spotify 或 YouTube 这类不拥有内容版权的平台而言，播放列表是一种关键机制，借此可以行使我们所谓的“策展权”：即通过内容的组织与编排来推进自身利益并影响他人利益的能力。
...
> 然而，随着唱片公司对 Spotify 播放列表的依赖日益加深，不满的暗流正在浮现。最令唱片公司沮丧的是，进入播放列表的整个流程缺乏透明度。Spotify 告知艺人和唱片公司，他们的曲目需要先在小型播放列表上表现良好，才有可能被考虑纳入 Spotify 官方编辑的播放列表。然而，尽管歌曲在播放列表中的位置部分取决于互动率、曝光量、收听时长和跳过率（Bonini & Gandini, 2019），艺人或其唱片公司却无法确切知晓某首曲目被加入或替换出播放列表的具体原因。正如 Spotify 全球音乐主管 Nick Holmsten 所承认的：“我们从唱片公司、艺人及其团队那里收到的最常见问题是：我该找谁（才能让作品）进入 Rap Caviar、Hot Country、Viva Latino、Ultimate Indie 或其他 Spotify 播放列表？”（"Spotify Launches New Playlist Consideration Feature for Artists, Labels," 2018）。这一流程的不透明性与形式化，让一些行业资深人士怀念起那个依赖与电台或唱片店联系人私交来推广音乐的时代。正如一位匿名行业消息人士在采访中告诉我的那样：
> 
...
> 因此，尽管艺术家和唱片公司日益依赖于获取 Spotify 播放列表的曝光机会，但在音乐市场中，Spotify 仍然高度依赖于内容提供方——尤其是高度整合的大型唱片集团。虽然大型唱片公司乐于让 Spotify 推动其利润增长，但它们也意识到让 Spotify 变得过于主导所带来的风险。正如另一位大型唱片公司的消息人士向 Music Business Worldwide 所言：“众所周知，在 [音乐流媒体] 领域保持四到五个具有全球影响力的参与者对我们至关重要……因此，任何能够促进竞争且不会让 Spotify 独占优势的做法在当下都是有益的”（Ingham，2018c）。
...
> 促进竞争的一种方式是扶持竞争对手。作为 Spotify 在西方市场最直接的竞争者，Apple Music 已成为备受青睐的挑战者。三大唱片公司中规模最大的环球音乐集团近期与 Apple 合作，共同推出了一个仅在 Apple Music 平台独家上线的播放列表品牌（Universal Music，2018）。另一案例是，隶属于第二大唱片公司索尼音乐娱乐旗下的英国舞曲厂牌 Ministry of Sound，在与 Apple 签署独家播放列表协议后，将其所有播放列表从 Spotify 平台下架（Aswad，2018）。
...
> 与其他在线出版商一样，Spotify 正努力应对广告屏蔽工具及其他广告规避手段的使用问题。原生广告已成为应对此问题的流行解决方案。[^5] 在 Spotify 上，播放列表为运用原生广告提供了最佳契机。近年来，Spotify 推出了多项原生广告功能，使品牌能够通过其策划的播放列表触达非付费订阅用户。其中一项功能即为“赞助播放列表”。该计划于 2016 年春季推出，允许品牌对 Spotify 策划的播放列表进行为期 1 周的赞助。除了在播放列表中突出展示品牌标识外，赞助品牌还将在每个广告插播时段“通过音频或视频信息包围听众”。正如 Spotify 向潜在赞助商所阐释的：
> 
> > - 我们将协助您选择最契合目标受众的播放列表，无论他们是关注“新音乐周五”的潮流引领者、收听“力量训练”的健身爱好者、通过“大脑营养”备考的学生，抑或其他群体。我们的播放列表已拥有热情而忠诚的粉丝基础，这能确保您的品牌得到广泛传播并被聆听。
...
> 正如 Eriksson 等人（2019年）所指出的，播放列表“在 Spotify 吸引广告商的战略中占据核心地位”（第137页）。播放列表使 Spotify 得以利用这样一种趋势：品牌“转向流行音乐，以使营销传播更具吸引力，甚至令人向往”（Meier，2017年，第12页）。播放列表的一个特殊优势在于，它们为品牌提供了梦寐以求的机会，能够伴随听众度过一整天，从而亲密地触及不同的时刻与情绪。这有助于理解 Spotify 创始人 Daniel Ek 那句广为流传的话：他的平台并非运作于“音乐空间”，而是“时刻空间”（Seabrook，2014年）。[^6]
